...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.0, 232.0, 144.0, 37.0 ],
									"presentation_rect" : [ 337.0, 305.5, 0.0, 0.0 ],
									"text" : "/foo : [\"a\", \"r\", \"s\", \"t\"],\n/bloo : [\"o\", \"i\", \"e\", \"n\"]",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 232.0, 94.0, 37.0 ],
									"text" : "/foo : [1, 2, 3],\n/bar : [4, 5, 6]",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 337.5, 150.0, 34.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 40.0, 295.5, 126.0, 20.0 ],
									"text" : "o.intersection"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 498.0, 352.0, 150.0, 20.0 ],
									"text" : "see also:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "clear" ],
									"patching_rect" : [ 483.5, 263.0, 198.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-1",
									"items" : [ "o.difference", ",", "o.union" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 498.0, 374.0, 132.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 498.0, 433.0, 53.0, 20.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 498.0, 409.0, 138.0, 20.0 ],
