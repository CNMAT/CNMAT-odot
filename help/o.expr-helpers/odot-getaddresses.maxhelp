...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 57.5, 300.0, 114.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 257.0, 308.0, 120.0 ],
					"text" : "/a : [1, 3, 5],\n/b : [222, 2, 3],\n/bndl : {\n\t/one : 1,\n\t/two : 2\n},\n/names/of/all : [\"/a\", \"/b\", \"/bndl\"],\n/names/in/specific/bundle : [\"/one\", \"/two\"]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 29.0, 200.0, 323.0, 43.0 ],
