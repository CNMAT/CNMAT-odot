...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 23.0, 69.0, 20.0 ],
					"text" : "cos()"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 58.0, 72.0, 74.0 ],
					"text" : "Cosine of x\n\narguments: \n\n1. x input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 79.0, 145.0, 71.0, 22.0 ],
					"text" : "o.route /cos"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 283.0, 167.0, 46.0 ],
					"text" : "/ramp : 2.70177,\n/cos : -0.904827"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0, 58.0, 275.0, 44.0 ],
					"text" : "/ramp = scale(/ramp, -1, 1, 0, twopi()),\n/cos = cos(/ramp)"
				}
