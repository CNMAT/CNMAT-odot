...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.5, 100.5, 178.0, 20.0 ],
					"text" : "(a0 x b0) + (a1 x b1) + (a2 x b2)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 18.0, 66.0, 24.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 18.0, 94.0, 20.0 ],
					"text" : "dot()"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 49.0, 196.0, 127.0 ],
					"text" : "The dot product\n\nReturns the sum of the products of two sequences of numbers (lists).  \n\narguments:\n\n1. list 1\n2. list 2 "
				}
