...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 368.0, 150.0, 47.0 ],
					"text" : "/foo : [1, 2, 3],\n/bar : [4, 5, 6]",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 267.0, 144.0, 37.0 ],
					"text" : "/foo : [\"a\", \"r\", \"s\", \"t\"],\n/bloo : [\"o\", \"i\", \"e\", \"n\"]",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 267.0, 94.0, 37.0 ],
					"text" : "/foo : [1, 2, 3],\n/bar : [4, 5, 6]",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 78.0, 326.0, 125.0, 20.0 ],
					"text" : "o.difference"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.0, 418.0, 150.0, 20.0 ],
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 500.0, 440.0, 132.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 499.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 475.0, 138.0, 20.0 ],
