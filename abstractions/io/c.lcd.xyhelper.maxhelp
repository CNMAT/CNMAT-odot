...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 340.0, 480.0, 181.0, 20.0 ],
					"text" : "o.cond /myparam/button == true"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 286.0, 353.0, 74.0, 20.0 ],
					"text" : "o.pack /size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 174.0, 353.0, 89.0, 20.0 ],
					"text" : "o.pack /mouse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 40.0, 353.0, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 40.0, 428.0, 141.0, 20.0 ],
					"text" : "c.lcd.xyhelper /myparam"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 286.0, 35.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 286.0, 65.0, 120.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 120.0, 220.0, 220.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 171.5, 457.0, 31.5, 457.0, 31.5, 110.0, 49.5, 110.0 ],
					"source" : [ "obj-11", 1 ]
				}
