...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 220.0, 340.0, 25.0, 25.0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 450.0, 180.0, 365.0, 114.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 139.5, 100.0, 115.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 319.5, 250.0, 526.0, 20.0 ],
					"text" : "o.expr map(lambda(addy){assign(\\\"/ser/\\\" + /serialnumber + addy\\, value(addy))\\;}\\, getaddresses())"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 360.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 300.0, 33.0, 20.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 30.0, 360.0, 37.0, 20.0 ],
					"text" : "o.var"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 30.0, 410.0, 65.0, 20.0 ],
					"text" : "o.prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 50.0, 59.0, 18.0 ],
					"text" : "diagnose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 120.0, 80.0, 83.0, 20.0 ],
					"text" : "o.io.esplora b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 30.0, 80.0, 83.0, 20.0 ],
					"text" : "o.io.esplora a"
				}
