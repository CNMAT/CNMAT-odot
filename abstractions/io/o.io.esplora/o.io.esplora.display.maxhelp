...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 180.0, 170.0, 50.0, 20.0 ],
									"text" : "o.union"
								}
...
,
					"patching_rect" : [ 536.0, 110.0, 45.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.0, 28.5, 65.0, 24.0 ],
					"text" : "turn on"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 506.0, 28.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.5, 120.0, 93.0, 20.0 ],
					"text" : "example output"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 609.5, 37.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 80.0, 92.0, 47.0 ],
					"text" : "/led/red 118\n/led/green 229\n/led/blue 0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 80.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 270.0, 110.0, 116.0, 20.0 ],
					"text" : "o.pack /led/onboard"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 22.5, 120.0, 74.0 ],
					"text" : "tone and rgb are not controllable on the board, but accessible via software input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 22.5, 85.0, 20.0 ],
					"text" : "/tone 22 500",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 634.0, 42.0, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 50.0, 85.0, 20.0 ],
					"text" : "/tone 200 500",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 20.0, 84.0, 89.0, 20.0 ],
					"text" : "o.pack /led/rgb"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 22.5, 190.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -24.0, -5.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 440.0, 522.0, 237.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -24.0, -5.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 150.0, 522.0, 237.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 239.5, 139.75, 29.5, 139.75 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 279.5, 139.5, 29.5, 139.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 127.5, 139.0, 29.5, 139.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 29.5, 139.5, 29.5, 139.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 239.5, 139.5, 29.5, 139.5 ],
					"source" : [ "obj-8", 0 ]
				}
