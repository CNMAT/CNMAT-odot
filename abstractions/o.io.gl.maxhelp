...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 329.0, 271.0, 177.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 182.0, 150.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 106.0, 163.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 302.0, 150.0, 74.0 ],
					"text" : "/a \"$1\" \"$1\" -0.2 \n/b -0.4 0.6 0.4 \n/c -0.6 0.2 -0.6 \n/color 0.2 \"$1\" 0.8 \n/shape \"triangle\" ",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 271.0, 150.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 184.0, 150.0, 60.0 ],
					"text" : "/position \"$1\" \"$1\" \"$1\" \n/color 0.7 0.9 0.5 \n/radius 0.1 \n/shape \"framecircle\" ",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 107.0, 150.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 61.0, 46.0, 20.0 ],
					"text" : "line 0."
				}
