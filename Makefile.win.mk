OBJECT_LIST = o.append o.atomize o.change o.collect o.cond o.dict o.difference o.downcast o.explode o.expr o.flatten o.if \
o.intersection o.iterate o.mappatch o.message o.pack o.pak o.prepend o.print o.printbytes o.route o.schedule o.select o.table \
