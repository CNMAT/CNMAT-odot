...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 682.802917, 829.212891, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.928955, 202.311966, 150.0, 29.0 ],
					"text" : "exponential"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 516.427979, 81.190979, 150.0, 29.0 ],
					"text" : "fibonacci"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.674927, 134.430969, 150.0, 29.0 ],
					"text" : "counting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1026.200928, 83.852989, 348.31897, 29.0 ],
					"text" : "damped exponential sinusoid"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.099976, 505.779968, 150.0, 51.0 ],
					"text" : "2: crank the state transitions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.26297, 541.635986, 150.0, 29.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 395.495972, 497.959991, 93.0, 29.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 390.001953, 779.002014, 234.0, 29.0 ],
					"text" : "o.if bound(/until) && /until"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.091003, 728.664001, 197.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1004.184021, 274.514984, 61.0, 27.0 ],
					"text" : "0.125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.184021, 278.514984, 33.0, 27.0 ],
					"text" : "27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 836.184021, 277.514984, 32.5, 27.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 870.120972, 95.584991, 61.0, 27.0 ],
					"text" : "0.992"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 775.120972, 88.584991, 32.5, 27.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 82.488052, 801.297974, 127.0, 29.0 ],
					"text" : "o.route /state"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 79.782066, 844.334961, 278.654999, 160.669006 ],
					"setstyle" : 4,
					"size" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 28.042002, 528.967041, 54.605995, 54.605995 ]
				}
