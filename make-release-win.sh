...
legit_externs=(o.append o.change o.collect o.compose o.cond o.context o.dict o.difference o.display o.edge~ o.explode o.expr.codebox o.flatten o.if o.intersection o.listenumerate o.pack o.prepend o.print o.printbytes o.route o.schedule o.select o.timetag o.union o.unless)
