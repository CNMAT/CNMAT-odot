...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 74.0, 150.0, 321.0, 61.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 74.0, 564.0, 113.0, 61.0 ],
					"text" : "/cell = /new, \n/currentPoint = 1, \n/generation++",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 74.0, 384.5, 326.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 74.0, 315.5, 353.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 764.0, 210.0, 53.0, 20.0 ],
					"text" : "r toPrint"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 660.0, 55.0, 20.0 ],
					"text" : "s toPrint"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 270.0, 55.0, 20.0 ],
					"text" : "s toPrint"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 74.0, 234.5, 49.0, 20.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 764.0, 270.0, 35.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 764.0, 240.0, 74.0, 20.0 ],
					"text" : "o.route /cell"
				}
