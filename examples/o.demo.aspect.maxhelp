...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 16.0, 112.0, 85.0, 20.0 ],
									"text" : "o.aspect.send"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 16.0, 80.0, 463.0, 20.0 ],
...
,
					"patching_rect" : [ 464.0, 112.0, 115.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 464.0, 80.0, 118.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 24.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 56.0, 150.0, 47.0 ],
					"text" : "/foo \"$1\"\n/bar 20\n/_aspect/profile",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/john/Development/CNMAT/CNMAT/CNMAT-odot/demos",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
