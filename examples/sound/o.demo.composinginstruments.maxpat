...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.0, 78.0, 119.0, 42.0 ],
					"text" : "/key/down false\n/key/number 31",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.0, 76.0, 110.0, 57.0 ],
					"text" : "/key/down true\n/key/number 31",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 590.0, 136.0, 29.0 ],
					"text" : "o.print second"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 454.0, 104.0, 29.0 ],
					"text" : "o.print first"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.0, 123.0, 149.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 474.0, 412.0, 67.0 ],
					"text" : "/play/end true\n/play/begin false\n/instance 65.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 119.0, 27.0, 26.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 82.0, 119.0, 42.0 ],
					"text" : "/key/down false\n/key/number 30",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 80.0, 110.0, 57.0 ],
					"text" : "/key/down true\n/key/number 30",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
