...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.175537, 380.0, 150.0, 33.0 ],
					"text" : "Dave Defilippo\nAdrian Freed 2014"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.175537, 181.5, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.175537, 142.0, 40.0, 20.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 210.175537, 94.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.175537, 175.5, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 64.175537, 101.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 64.175537, 142.0, 40.0, 20.0 ],
					"text" : "zl reg"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 246.0, 100.0, 20.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 183.5, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 209.5, 53.0, 20.0 ],
									"text" : "midiinfo"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 131.0, 333.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 64.175537, 61.5, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 14.0,
					"framecolor" : [ 0.501961, 0.0, 0.0, 0.34 ],
					"id" : "obj-2",
					"items" : [ "AU DLS Synth 1", ",", "from Max 1", ",", "from Max 2", ",", "QUNEO" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.175537, 3.5, 134.0, 22.0 ],
					"rounded" : 19,
					"truncate" : 0
				}
