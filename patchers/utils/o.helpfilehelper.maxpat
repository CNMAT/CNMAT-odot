...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 414.666687, 427.0, 49.0, 20.0 ],
					"text" : "t l clear",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.666687, 495.0, 98.0, 20.0 ],
					"text" : "prepend append",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.666687, 456.0, 27.0, 20.0 ],
					"text" : "iter",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 248.666672, 427.0, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.666656, 472.0, 74.0, 20.0 ],
					"text" : "prepend set",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.666672, 472.0, 74.0, 20.0 ],
					"text" : "prepend set",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.666664, 472.0, 74.0, 20.0 ],
					"text" : "prepend set",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 316.0, 184.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 242.0, 169.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 795.0, 84.0, 82.0, 18.0 ],
					"text" : "obj o.atomize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 705.0, 466.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 382.0, 214.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 705.0, 135.0, 57.0, 20.0 ],
					"text" : "route obj"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 175.0, 221.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 261.0, 32.5, 18.0 ],
					"text" : "doc",
					"varname" : "docmsg"
				}
