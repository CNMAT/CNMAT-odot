...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1064.0, 573.0, 150.0, 34.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 188.0, 548.0, 253.0, 100.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 229.0, 445.0, 253.0, 87.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 492.0, 214.0, 150.0, 74.0 ],
													"text" : "/a : [\"$1\", \"$1\", -0.2],\n/b : [-0.4, 0.6, 0.4],\n/c : [-0.6, 0.2, -0.6],\n/color : [0.2, \"$1\", 0.8],\n/shape : \"triangle\"",
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 141.714294, 214.0, 154.0, 87.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 470.0, 326.0, 150.0, 87.0 ],
													"text" : "/position : [0., 0.],\n/red,\n/radius/outer : \"$1\",\n/radius/inner : 0.05,\n/orientation : [0, 45, 90],\n/shape : \"torus\"",
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 266.714294, 708.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 310.5, 390.0, 592.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 821.0, 210.0, 150.0, 24.0 ],
									"text" : "/displaylist",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 734.5, 111.5, 105.5, 20.0 ],
									"text" : "o.righttoleft"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 8,
									"outlettype" : [ "FullPacket", "FullPacket", "FullPacket", "FullPacket", "FullPacket", "FullPacket", "FullPacket", "FullPacket" ],
									"patching_rect" : [ 30.0, 169.5, 299.5, 20.0 ],
									"text" : "o.righttoleft"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 821.0, 169.5, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 738.0, 553.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 825.0, 602.0, 61.0, 20.0 ],
									"text" : "o.recurse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 790.0, 537.0, 50.0, 20.0 ],
									"text" : "o.union"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 738.0, 639.0, 37.0, 20.0 ],
									"text" : "o.var"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 790.0, 565.0, 276.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 131.0, 437.0, 133.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 734.5, 67.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 738.0, 676.0, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 53.0, 190.0, 62.0, 20.0 ],
					"text" : "o.gl place"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 50.0, 246.728882, 75.0, 20.0 ],
									"text" : "o.pack /time"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 49.0, 111.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 283.728882, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 395.0, 190.0, 416.0, 359.0 ],
					"pickray" : 1
				}
