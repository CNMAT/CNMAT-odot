...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"name" : "o.demo.meter.pong",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 732.0, 112.0, 399.0, 322.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 167.0, 205.0, 50.0, 20.0 ],
									"text" : "o.union"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 202.0, 127.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "o.expr /reset = 1\\; /position = [ /ball/x/position\\, /ball/y/position\\, /ball/z/position ]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 167.0, 285.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 560.0, 463.0, 295.0, 20.0 ],
...
,
					"text" : "p make an osc packet describing the position of a ball"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 539.0, 39.0, 166.0, 141.0 ],
					"text" : "Emergent metric patterns\n\nAdrian Freed\n2012, 2013\n\nThe faders control the components of the velocity vector of the ball. Hits are computed when the ball hits the reflecting boundaries."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 139.0, 491.0, 426.0, 20.0 ],
					"text" : "o.expr /distance = 4*l2norm ( [/ball/y/position \\, /ball/x/position\\, /ball/z/position] )"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.0, 150.0, 117.0, 20.0 ],
