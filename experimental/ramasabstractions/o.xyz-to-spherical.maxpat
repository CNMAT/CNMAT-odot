...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 207.0, 104.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 46.0, 85.0, 97.0, 19.0 ],
					"text" : "o.in @name main"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 127.0, 271.0, 56.0 ],
					"text" : " /radius = sqrt( /x*/x + /y*/y + /z*/z);\n /declination = acos( /z / /radius);\n /theta = atan2(/y, /x);",
