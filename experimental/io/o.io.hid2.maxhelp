...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 240.0, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 398.0, 150.0, 56.0 ],
					"text" : "/6 0\n/5 0\n/4 0\n/3 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 204.0, 63.0, 17.0 ],
					"text" : "getdevices"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 234.5, 313.0, 38.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 394.0, 204.0, 52.0, 19.0 ],
					"text" : "o.io.hid2"
				}
