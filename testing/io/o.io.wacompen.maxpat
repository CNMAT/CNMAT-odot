...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 550.0, 250.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 584.0, 302.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 50.0, 516.0, 250.0, 20.0 ],
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 281.0, 630.0, 540.0, 20.0 ],
...
,
					"patching_rect" : [ 970.0, 430.0, 139.770386, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 390.0, 22.5, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 52.5, 110.0, 60.0 ],
					"text" : "/s2m \"poll\"\n/s2m \"nopointer\" 1\n/s2m \"xyrange\" 1\n/s2m \"menu\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 210.0, 22.5, 58.0, 20.0 ],
					"text" : "freebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 52.5, 126.700012, 20.0 ],
					"text" : "/s2m \"nopoll\"",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 210.0, 75.0, 17.0 ],
					"text" : "nopointer $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "FullPacket" ],
					"patching_rect" : [ 50.0, 140.0, 147.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 690.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 50.000015, 450.0, 830.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-55",
					"items" : [ "All tablets and tools", ",", "<separator>", ",", "(0: Intuos2 4x5 / all tools)", ",", "(0: Intuos2 4x5 / 1: Grip Pen)" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 780.0, 190.0, 178.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 178.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 293.299988, 420.0, 100.100014, 19.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 50.0, 420.0, 100.099998, 19.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 50.0, 280.0, 918.200012, 20.0 ],
					"text" : "s2m.wacom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 536.599976, 420.0, 27.0, 20.0 ],
					"text" : "& 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 455.5, 420.0, 27.0, 20.0 ],
					"text" : "& 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 617.700012, 420.0, 27.0, 20.0 ],
					"text" : "& 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 958.700012, 321.0, 983.851807, 321.0, 983.851807, 172.0, 789.5, 172.0 ],
					"source" : [ "obj-3", 8 ]
				}
