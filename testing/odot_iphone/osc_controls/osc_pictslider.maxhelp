...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "int", "", "" ],
									"patching_rect" : [ 434.0, 103.0, 83.0, 20.0 ],
									"text" : "osc_pictslider"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 434.0, 136.0, 100.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 224.5, 331.0, 100.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "int", "", "" ],
									"patching_rect" : [ 224.5, 87.0, 83.0, 20.0 ],
									"text" : "osc_pictslider"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 224.5, 120.0, 100.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "int", "", "" ],
									"patching_rect" : [ 19.0, 303.0, 83.0, 20.0 ],
									"text" : "osc_pictslider"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 19.0, 331.0, 100.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 9.0, 294.0, 36.0, 24.0 ],
									"text" : "x"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 45.0, 347.0, 100.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 327.0, 176.5, 213.0, 75.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 148.5, 238.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 265.0, 165.0, 38.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 57.0, 235.0, 79.0, 39.0 ],
									"text" : "pictslider #"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 88.0, 575.0, 48.0 ],
									"text" : "osc_pictslider interprets osc messages from the iphone using  touchosc, oscemote, iosc, mrmr, as well as a particular processing sketch, provided in the odot_iphone folder. Make sure to use port 10000 to send osc messages.",
...
, 							{
								"box" : 								{
									...
									"text" : "Converts pictsliders from osc apps to pictsliders in Max"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 160.0, 304.0, 249.0, 320.0 ],
									"source" : [ "obj-7", 3 ]
								}
